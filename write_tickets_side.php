            ...
            <?php
                if(isset($_POST['title_text']) &&isset($_POST['text_add']))
                {
                    ...
                    else
                    {
                        ...
                        $sql = "INSERT INTO `ticket_db`(`Date_added`, `Title`, `Author_name`, `Author_surname`, `Author_email`, `Status`, `Priority`, `Value`) VALUES ('$nowDate','$title','$namet','$snamet','$emailt','1','0',' $textt')";
